...
const COMMAND_HELP = {
  ...
  staff: [
    ...
    '`/license grant` — Grant a license without a ticket (optional promo).',
    '`/license extend` — Add months to a license.',
    '`/license list` — View active (or all) buyer licenses.',
    '`/license revoke` — End a buyer\'s license and remove their role.',
    '`/license check` — View a user\'s license record.',
    '`/blacklist add|remove|list` — Block users from purchase lanes.',
